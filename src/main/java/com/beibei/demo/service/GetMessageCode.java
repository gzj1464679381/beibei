...
public class GetMessageCode {
    ...
    private static final String ACCOUNT_SID = "148a7a38341447eaa9db234e692e47be";
    private static final String AUTH_TOKEN = "60612f7d1cd44c8daa33517e583a6bbb";
    ...
    public static String getCode(String phone) {
        ...
        int i=1;
        String tamp = "【恒迹集团】您的验证码为"+rod+"，请于"+i+"分钟内正确输入，如非本人操作，请忽略此短信。";
    ...
    public static void main(String[] args) {
        String i=GetMessageCode.getCode("15383517359");
